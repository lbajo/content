...
description: |-
    This profile contains rules to ensure standard security baseline of an Ubuntu 18.04 system. Regardless of your systems workload all of these checks should pass.
